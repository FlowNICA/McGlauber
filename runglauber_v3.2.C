...
void TGlauNucleus::Lookup(const char* name)
{
  ...
  else if (TString(name) == "I")       {fN = 127; fR = 5.66;       fA = 0.54;   fW =  0;       fF = 1;  fZ=53;} // fR = 1.19 * pow(A,1./3.) - 1.61 * pow(A,-1./3.)
  else if (TString(name) == "IHS")     {fN = 127; fR = 5.66;       fA = 0.00001;fW =  0;       fF = 1;  fZ=53;} // hard sphere approximation
  ...
  else if (TString(name) == "Xe124HS") {fN = 124; fR =  5.431;     fA = 0.00001;fW =  0;       fF = 1;  fZ=54;} // hard sphere approximation
  else if (TString(name) == "CsI")     {fN = 130; fR = 5.71;       fA = 0.54;   fW =  0;       fF = 1;  fZ=54;} // fR = 1.19 * pow(A,1./3.) - 1.61 * pow(A,-1./3.)
  else if (TString(name) == "CsIHS")   {fN = 130; fR = 5.71;       fA = 0.00001;fW =  0;       fF = 1;  fZ=54;} // hard sphere approximation
  else if (TString(name) == "Cs")      {fN = 133; fR = 5.76;       fA = 0.54;   fW =  0;       fF = 1;  fZ=55;} // fR = 1.19 * pow(A,1./3.) - 1.61 * pow(A,-1./3.)
  else if (TString(name) == "CsHS")    {fN = 133; fR = 5.76;       fA = 0.00001;fW =  0;       fF = 1;  fZ=55;} // hard sphere approximation
  else if (TString(name) == "W184")    {fN = 184; fR = 6.52;       fA = 0.535;  fW =  0;       fF = 1;  fZ=74;}
  ...
  else if (TString(name) == "Bi")      {fN = 209; fR = 6.75;       fA = 0.468;  fW =  0;       fF = 1;  fZ=83;} // 2pF model from https://www.cns.s.u-tokyo.ac.jp/~gunji/tmp/tmp2/AtomicData_NuclearData_14_485.pdf
  else if (TString(name) == "BiGS")    {fN = 209; fR = 6.315;      fA = 2.881;  fW =  0.39;    fF = 2;  fZ=83;} // 3pG model from https://www.cns.s.u-tokyo.ac.jp/~gunji/tmp/tmp2/AtomicData_NuclearData_14_485.pdf
  ...
  switch (fF) {
    ...
    case 15: // harmonic oscillator model 
      ...
      fFunc1->SetParameters(fR,fA);
      break;
    case 16: // 2pF - same as 3pF (case 1) for parameter [2] = 0
      fFunc1 = new TF1(name,"x*x/(1+exp((x-[0])/[1]))",0,fMaxR);
      fFunc1->SetParameters(fR,fA);
      break;
    default:
