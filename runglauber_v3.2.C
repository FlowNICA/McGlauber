...
void TGlauNucleus::Lookup(const char* name)
{
  ...
  else if (TString(name) == "IHS")     {fN = 127; fR = 6.03;       fA = 0.00001;fW =  0;       fF = 1;  fZ=53;} // hard sphere approximation
  ...
  else if (TString(name) == "CsIHS")   {fN = 130; fR = 6.07;       fA = 0.00001;fW =  0;       fF = 1;  fZ=54;} // hard sphere approximation
  else if (TString(name) == "Cs")      {fN = 133; fR = 6.125;      fA = 0.5;    fW =  0;       fF = 1;  fZ=55;} // fR = 1.2 * pow(A,1./3.)
  else if (TString(name) == "CsHS")    {fN = 133; fR = 6.125;      fA = 0.00001;fW =  0;       fF = 1;  fZ=55;} // hard sphere approximation
